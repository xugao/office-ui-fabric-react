...
export const getStyles = (props: ICheckboxStyleProps): ICheckboxStyles => {
  const { className, theme, reversed, isUsingCustomLabelRender, checked, disabled, indeterminate } = props;
  ...
  // TODO: after updating the semanticColors slots mappisng this needs to be semanticColors.inputBorder
