...
function _createAnimation(
  keyframes: IKeyframes[] | IKeyframes,
...
function _createSlideInX(fromX: number) {
  return {
...
function _createSlideInY(fromY: number) {
  return {
...
function _createSlideOutX(toX: number) {
  return {
...
function _createSlideOutY(toY: number) {
  return {
    from: { transform: `translate3d(0,0,0)` },
